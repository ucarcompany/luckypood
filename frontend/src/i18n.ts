...
const resources = {
  ...
  refresh_failed: 'Refresh failed',
    ...
    provider_final_hint: 'The drops are gathering into a river today, please wait patiently. If it takes too long the drops might be lost — try refreshing or check your network. Thank you ~',
  ...
  refresh_failed: '刷新失败',
    ...
    provider_final_hint: '小水滴正在今日汇聚成河，请您耐心等待，若长时间未加载成功，小水滴可能走丢了，请尝试刷新或检查网络，谢谢~',
